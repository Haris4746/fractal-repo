...
namespace FracMaster
{
    ...
    public class MandelbrotFractal : Generic2DFractal 
    {
        ...
        public MandelbrotFractal()  //Mandlebrot calculation method, public to other 2 fractal calculations.
        {                                            
            ...
            //THESE ARE FIXED VALUES WHICH CORRELATE TO DRAWING A FRACTAL ON A BITMAP. 
            pars.SetValue("PALETTE", pal);

        }

        public override void Configure() //Configuration method
        {
        ...
        override protected void PartialRender(object P)  //Create mandlebrot object and set its paramaters to be drawn
        {
            object[] o = (object[])P;
            int offset=(int)o[0];
            int lines = (int)o[1];
           ...
           //////////////////////////////////////////////////////////////////////////////
            ...
            completed.Set(); //Set will render succesfully otherwise it'll throw and exception.
        }
