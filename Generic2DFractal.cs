...
namespace FracMaster //Creates and drives the base parameters for the rendering of the fractal.
{
    public class Generic2DFractal : GenericFractal
    {
        ...
        virtual public void SetOrigin(double dx, double dy)  //Create fractal render area.
        {
        ...
        virtual public void SetControlParameter(double dx, double dy)  //Allow the fractal to scale based of user inputs and edits.
        {
            double CurWpix = (int)pars.GetValue("WIDTH");
            double CurHpix = (int)pars.GetValue("HEIGHT");
            double FracWidth = (double)pars.GetValue("W");
