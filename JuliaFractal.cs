...
namespace FracMaster
{
    public class JuliaFractal : Generic2DFractal
    {
        ...
        public JuliaFractal()
        {
            pars.SetValue("NAME", "Julia Fractal"); //fractal type
            pars.SetValue("X", 0.5); //xval
            pars.SetValue("Y", -0.2);//y val
            ...
            pars.SetValue("ITERATIONS", 128); //iteration sequence
            ...
            Int32[] pal = { -16777108, -16777099, -16777089, -16777079, -16777069, -16777059,
                            ...
                            -460552, -394759, -328966, -263173, -197380, -131587, -16777216 }; //reads point to point co-ordinates
            //These are signed integers.

            pars.SetValue("PALETTE", pal); //Create pallette
        }

        public override void Configure() //configuration window 
        {
        ...
        {
            object[] o = (object[])P; //create window object
            int offset = (int)o[0];
            int lines = (int)o[1];
            int[] dst = (int[])o[2];
            ...
            int width = (int)pars.GetValue("WIDTH"); //get different window variables and display inside GUI
