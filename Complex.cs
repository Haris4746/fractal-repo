...
namespace ComplexMath //This class contains the math formulas for the fratcal calculation
{	 
	public struct Complex : IComparable 
    {
        ...
        //Create non modifiable numerical values	  
      
        public double Re;         
        public double Im;
               //Create fractal areas/Radius and calculate using individual set.
