...
{
    /*THIS IS THE BASE CLASS FOR ANY FRACTAL RENDER
     * PLEASE SEE MANDLEBROT CLASS OR TEST FRACAL TO SEE HOW I HAVE RENDERED each individual FRACTAL
     * 
     */
    public class GenericFractal : IFractal 
    {
      ...
      //Method to read from saved XML document.
        ...
        virtual  public void ReadFromXml(String filename) //finds filename
        {
           // 
            try
            {
        ...
        //Fractal parameter window
        //Finds and returns parameters such as window size, calc time and render asset time
        ...
        virtual protected void RenderFunction(object o)  //Object overrite for window edit
        {
